...
//        console.log(this.titleBool);
    }

    mouseParallax = function(id, left, top, mouseX, mouseY, speed ) {
        if(mobilecheck()) {
           return
        }
...
//            
//            var cont = obj.classList.contains('switched');
//            if(cont) {
//                return;
//            }
//            
        var parentObj = this.parallaxBox.nativeElement;
    ...
    mouseMove = function ( event ) {
            ...
            this.mouseParallax ( 'l1', c1left, c1top, x, y, 14 );
            this.mouseParallax ( 'l2', c2left, c2top, x, y, 6 );
        }
    ...
    ngAfterViewInit() { 
        ...
        this.parallaxBox.nativeElement.addEventListener('mousemove', this.mouseMove);
//        console.log(this.parallaxBox);
        this.parallaxBox.nativeElement.classList.add('visible');
